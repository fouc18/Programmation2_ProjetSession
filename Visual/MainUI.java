...
public class MainUI extends JFrame {
	...
	public MainUI() {
		...
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			setContentPane(new JLabel(new ImageIcon("Visual/Images/interface.jpg")));
	...
	private void initComponents() {
		...
		AF.setIcon(new ImageIcon("Visual/Images/gps_AF.png")); // NOI18N
		getContentPane().add(AF, new org.netbeans.lib.awtextra.AbsoluteConstraints(638, 448, 110, -1));

		GF.setIcon(new ImageIcon("Visual/Images/gps_GF.png")); // NOI18N
		getContentPane().add(GF, new org.netbeans.lib.awtextra.AbsoluteConstraints(739, 449, -1, -1));

		HE.setIcon(new ImageIcon("Visual/Images/gps_HE.png")); // NOI18N
		...
		ED.setIcon(new ImageIcon("Visual/Images/gps_ED.png")); // NOI18N
	...
	/**
	 * Permet de convertir le noeud de caractÃƒÂ¨re en nombre
	 * 
